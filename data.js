...
const ITEMS = [
  ...
  },
  {
    ...
    cost: 3000,
    category: "micro",
    emoji: '<i class="fas fa-mosquito"></i>',
  ...
  },
  {
    ...
    cost: 5000,
    category: "micro",
    emoji: '<i class="fas fa-apple-alt"></i>',
  ...
  },
  {
    ...
    cost: 10000,
    category: "micro",
    emoji: '<i class="fas fa-ear-listen"></i>',
  ...
  },
  {
    ...
    cost: 5000,
    category: "micro",
    emoji: '<i class="fas fa-syringe"></i>',
  ...
  // 💧 Community Projects ($10K – $250K)
  {
    ...
    cost: 150000,
    category: "community",
    emoji: '<i class="fas fa-book-open"></i>',
  ...
  },
  {
    ...
    cost: 75000,
    category: "community",
    emoji: '<i class="fas fa-can-food"></i>',
  ...
  },
  {
    ...
    cost: 200000,
    category: "community",
    emoji: '<i class="fas fa-clinic-medical"></i>',
  ...
  },
  {
    ...
    cost: 250000,
    category: "community",
    emoji: '<i class="fas fa-graduation-cap"></i>',
  ...
  // 🌾 Regional Development ($250K – $5M)
  {
    ...
    cost: 1000000,
    category: "regional",
    emoji: '<i class="fas fa-wheat-awn"></i>',
  ...
  },
  {
    ...
    cost: 3000000,
    category: "regional",
    emoji: '<i class="fas fa-hospital"></i>',
  ...
  },
  {
    ...
    cost: 4000000,
    category: "regional",
    emoji: '<i class="fas fa-droplet"></i>',
  ...
  },
  {
    ...
    cost: 2500000,
    category: "regional",
    emoji: '<i class="fas fa-chalkboard-teacher"></i>',
  ...
  },
  {
    ...
    cost: 1200000,
    category: "regional",
    emoji: '<i class="fas fa-satellite-dish"></i>',
  ...
  },
  {
    ...
    cost: 30000000,
    category: "national",
    emoji: '<i class="fas fa-money-bill-wave"></i>',
  ...
  },
  {
    ...
    cost: 60000000,
    category: "national",
    emoji: '<i class="fas fa-solar-panel"></i>',
  ...
  },
  {
    ...
    cost: 300000000,
    category: "global_health",
    emoji: '<i class="fas fa-shield-virus"></i>',
  ...
  },
  {
    ...
    cost: 15000000000,
    category: "mega",
    emoji: '<i class="fas fa-bread-slice"></i>',
  ...
  },
  {
    ...
    cost: 10000000000,
    category: "mega",
    emoji: '<i class="fas fa-recycle"></i>',
  ...
  },
  {
    ...
    cost: 120000000000,
    category: "space",
    emoji: '<i class="fas fa-satellite"></i>',
  ...
  },
  {
    ...
    cost: 25000000000,
    category: "space",
    emoji: '<i class="fas fa-industry"></i>',
  ...
  },
  {
    ...
    cost: 80000000000,
    category: "space",
    emoji: '<i class="fas fa-arrow-up"></i>',
  ...
  },
  {
    ...
    cost: 400000000000,
    category: "society",
    emoji: '<i class="fas fa-globe-africa"></i>',
  ...
  // 🧠 Weird / Fun / Absurd ($1M – $500B)
  {
    ...
    cost: 44000000000,
    category: "absurd",
    emoji: '<i class="fab fa-twitter"></i>',
  ...
  },
  {
    ...
    cost: 10000000000,
    category: "absurd",
    emoji: '<i class="fas fa-glass-water"></i>',
  ...
  },
  {
    ...
    cost: 400000000000,
    category: "absurd",
    emoji: '<i class="fas fa-car-battery"></i>',
  ...
  },
  {
    ...
    cost: 20000000000,
    category: "absurd",
    emoji: '<i class="fas fa-football-ball"></i>',
  ...
  },
  {
    ...
    cost: 250000000000,
    category: "absurd",
    emoji: '<i class="fas fa-ferris-wheel"></i>',
...
const CATEGORIES = {
  micro: { name: "Micro Actions", emoji: '<i class="fas fa-seedling"></i>', color: "#10b981" },
  community: { name: "Community Projects", emoji: '<i class="fas fa-tint"></i>', color: "#3b82f6" },
  regional: { name: "Regional Development", emoji: '<i class="fas fa-wheat-awn"></i>', color: "#8b5cf6" },
  national: { name: "National Scale", emoji: '<i class="fas fa-city"></i>', color: "#f59e0b" },
  global_health: { name: "Global Health & Innovation", emoji: '<i class="fas fa-heartbeat"></i>', color: "#ec4899" },
  mega: { name: "Mega-Projects", emoji: '<i class="fas fa-globe"></i>', color: "#ef4444" },
  space: { name: "Global Tech & Exploration", emoji: '<i class="fas fa-satellite"></i>', color: "#6366f1" },
  society: { name: "Societal Redesign", emoji: '<i class="fas fa-hand-holding-usd"></i>', color: "#14b8a6" },
  absurd: { name: "Weird / Fun / Absurd", emoji: '<i class="fas fa-brain"></i>', color: "#f97316" }
};
